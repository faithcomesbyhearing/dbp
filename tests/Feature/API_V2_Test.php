...
class API_V2_Test extends TestCase
{
	 ...
	 * @category Swagger ID: BookOrder
	 * @category Route Name: v2_library_bookOrder
	 * @link Test Route Path: https://api.dbp.localhost/library/bookorder?v=2&dam_id=AAIWBTN2ET&key=&pretty
	 ...
	 * @link Route Path: https://api.dbp.localhost/library/metadata?v=2&id=AAIWBT&key=
	 *
	 */
