...
//		$response_v2 = $this->get("https://dbt.io/library/asset", $this->params);
	 ...
	 * @category Swagger ID: BookOrder
	 * @category Route Name: v2_library_bookOrder
	 * @link Route Path: https://api.dbp.dev/library/bookorder?v=2&dam_id=AAIWBTN2ET&key=&pretty
	 *
	 */
	 ...
	 * @link Route Path: https://api.dbp.dev/library/metadata?v=2&id=AAIWBT&key=
	 *
	 */
	 ...
	 * @link Route Path: https://api.dbp.dev/text/font?v=2&platform=web&key=&pretty
	 *
	 */
	 ...
	 * @link Route Path: https://api.dbp.dev/text/verse?v=2&key=&dam_id=ENGESV&book_id=GEN&chapter_id=1&verse_start=1&verse_end=10
	 *
	 */
