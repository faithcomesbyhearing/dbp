...
class BibleFilesetFactory extends Factory
{
    ...
    public function segmentationSection(): static
    {
        return $this->state(['segmentation_type' => 'section']);
    }

    public function segmentationChapter(): static
    {
        return $this->state(['segmentation_type' => 'chapter']);
    }
}
