...
class ProjectsSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        ...
        $oauth_table = $dbp_users . '.project_oauth_providers';
        Project::create([
        ...
        while ($project_count > 0) {
            ...
            ProjectOauthProvider::create([
                'id'            => unique_random($oauth_table, 'id'),
                'name'          => 'facebook',
                'project_id'    => $project_count,
                'client_id'     => unique_random($oauth_table, 'client_id'),
                'client_secret' => unique_random($oauth_table, 'client_secret'),
