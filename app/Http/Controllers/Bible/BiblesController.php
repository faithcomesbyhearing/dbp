...
class BiblesController extends APIController
{
        ...
        return cacheRemember('bibles_show_verify_content_response',
            ...
            function () use ($bible, $access_group_ids, $verify_content, $id, $verify_segmentation) {
                $verse_starts_map = $verify_segmentation
                    ? $this->loadVerseStartsMap($bible, $id)
                    : [];
                ...
                $book_fileset_map = cacheRemember(
                    ...
                    now()->addDay(),
                    function () use ($bible, $verify_segmentation, $verse_starts_map) {
     ...
     */
    private function loadVerseStartsMap(Bible $bible, string $bible_id) : array
    {
